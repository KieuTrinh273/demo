...
import com.myapp.ses.repository.ProductOrderRepository;
import com.myapp.ses.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.myapp.ses.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
