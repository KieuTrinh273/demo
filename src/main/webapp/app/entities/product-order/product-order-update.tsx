  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sesApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="sesApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sesApp.productOrder.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('sesApp.productOrder.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('sesApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('sesApp.productOrder.code')}
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('sesApp.productOrder.customer')}
                type="select"
              >
                <option value="" key="0" />
                {customers
