...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sesApp.productCategory.delete.question">
        <Translate contentKey="sesApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
