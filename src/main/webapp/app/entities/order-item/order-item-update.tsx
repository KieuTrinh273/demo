  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sesApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="sesApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sesApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('sesApp.orderItem.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('sesApp.orderItem.status')}
              ...
              >
                {orderItemStatusValues.map(orderItemStatus => (
                  <option value={orderItemStatus} key={orderItemStatus}>
                    {translate('sesApp.OrderItemStatus.' + orderItemStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('sesApp.orderItem.product')}
                type="select"
              >
                <option value="" key="0" />
                {products
              ...
              <ValidatedField id="order-item-order" name="order" data-cy="order" label={translate('sesApp.orderItem.order')} type="select">
                <option value="" key="0" />
                {productOrders
