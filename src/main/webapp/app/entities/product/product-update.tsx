  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sesApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="sesApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sesApp.product.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('sesApp.product.description')}
              ...
              />
              <ValidatedField
                label={translate('sesApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('sesApp.product.productSize')}
              ...
              >
                {sizeValues.map(size => (
                  <option value={size} key={size}>
                    {translate('sesApp.Size.' + size)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('sesApp.product.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                label={translate('sesApp.product.productCategory')}
                type="select"
              >
                <option value="" key="0" />
                {productCategories
